...
import { Alias, Resource, ResourceOptions, URN } from "../resource";
 ...
 */
export declare function readResource(res: Resource, parent: Resource | undefined, t: string, name: string, props: Inputs, opts: ResourceOptions, sourcePosition?: SourcePosition): void;
