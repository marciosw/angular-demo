...
Event: ${line}\n${e.toString()}`);
    ...
    refresh(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let refResult;
            try {
                refResult = yield this.runPulumiCmd(args, opts === null || opts === void 0 ? void 0 : opts.onOutput);
            }
            finally {
                yield cleanUp(logFile, yield logPromise);
            }
    ...
    destroy(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let desResult;
            try {
                desResult = yield this.runPulumiCmd(args, opts === null || opts === void 0 ? void 0 : opts.onOutput);
            }
            finally {
                yield cleanUp(logFile, yield logPromise);
            }
    ...
    runPulumiCmd(args, onOutput) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.workspace.pulumiCommand.run(args, this.workspace.workDir, envs, onOutput);
